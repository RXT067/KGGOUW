...
DESCRIPTION="Wine wrapper for leagueoflegends." # A short (not more than 80 characters) description of the package's purpose. Mandatory.
...
## TODO: Download wrapper

LICENSE="GPL-2" # The package's license, corresponding exactly (including case) to a file in licenses/. Mandatory (except for virtuals) - https://devmanual.gentoo.org/ebuild-writing/variables/index.html#license
## Licensing a wrapper and ebuild, game is all rights reserver which is respected.
...
|| (
>=app-emulation/wine-staging-3.14::*[${MULTILIB_USEDEP},vulkan, staging]]
>=app-emulation/wine-any-3.14::*[${MULTILIB_USEDEP},vulkan, staging]]
)
=app-emulation/winetricks-99999999" # https://devmanual.gentoo.org/general-concepts/dependencies/index.html
...
FILESDIR=${FILESDIR}
## ${PACKDIR}/files - workaround

WORKDIR=${WORKDIR}
## ${PACKDIR}/work - workaround
